...
Generate animated video from text description using PIL and MoviePy
...
def main():
    print("=" * 65)
    print(f"  Text To Video Generator")
    print("=" * 65)
    print(f"  Generate animated video from text description using PIL and MoviePy")
    print()
